...
void NavegarRegistros(){
        ...
        while (1){
            ...
            char dir;
            printf("n.(siguiente) | b.(anterior) | e.(salir): ");
            scanf("%c",&dir);
            while (getchar() != '\n');

            if(dir == 'n'){
                if(aux->next == NULL){
                    printf("No existen mas entradas hacia adenlante\n");
                }
                else{
                    aux = aux->next;
                }
                ...
                if(aux->prev == NULL){
                    printf("No existen mas entradas hacia atras\n");
                }
                else{
                    aux = aux->prev;
                }
